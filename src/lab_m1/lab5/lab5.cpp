...
void Lab5::Update(float deltaTimeSeconds)
{
...

    {
        ...
        modelMatrix = glm::scale(modelMatrix, glm::vec3(1.5, 0.5f, 1.1));
...

    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-2, 0.5f, -3));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(1, 1.4f, 0.8));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(10.0f), glm::vec3(1, 0, 0));
