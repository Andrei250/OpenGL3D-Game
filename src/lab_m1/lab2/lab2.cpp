...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(-1, -1, -1), glm::vec3(0.5f, 1, 0.5f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, -1, -1), glm::vec3(0, 0.5f, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1, 1, -1), glm::vec3(0.5f, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, -1), glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3(0.2, 0.8, 0.6)),
        ...
        vector<VertexFormat> tetraVert
        {
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1, -1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5f, 2, 0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),

        };

        vector<unsigned int> tetraInd =
        {
            0, 1, 2,
            1, 2, 3,
            0, 2, 3,
        ...
        vector<VertexFormat> squareVert
        {
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 1, 1), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 2, 1), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 2, 1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),

        };

        vector<unsigned int> squareInd =
        {
            0, 1, 2,
            3, 2, 0
        };
        ...
        CreateMesh("tetra", tetraVert, tetraInd);
        CreateMesh("square", squareVert, squareInd);
    }

    {
        vector<VertexFormat> tetraVert
        {
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), // 0
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // 1
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // 2
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), // 3
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // 4
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // 5
            VertexFormat(glm::vec3(0, 1, -1), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), // 6
            VertexFormat(glm::vec3(0, 1, -1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // 7
            VertexFormat(glm::vec3(0, 1, -1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // 8
            VertexFormat(glm::vec3(0.5f, 2, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // 9
            VertexFormat(glm::vec3(0.5f, 2, 0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // 10
            VertexFormat(glm::vec3(0.5f, 2, 0), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), // 11
        };
        ...
        CreateMesh("specialTetra", tetraVert, tetraInd);
    }
    ...
    {
        vector<VertexFormat> vert = buildCircle(200, glm::vec3(1, 1, 1), 2);
        vector<unsigned int> ind = buildCirclesTriangle(200);

        CreateMesh("circle", vert, ind);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(-1.5f, 1.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square

    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-1.5f, 1, 0), glm::vec3(0.25f));

    RenderMesh(meshes["specialTetra"], shaders["VertexColor"], glm::vec3(1, 1, 1), glm::vec3(0.25f));
...
vector<VertexFormat> Lab2::buildCircle(int numberOfVertices, glm::vec3 center, int radius)
{
    vector<VertexFormat> ans;

    ans.push_back(VertexFormat(center, glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)));

    for (int i = 0; i < numberOfVertices; ++i) {
        float rad = (1.0 * i * numberOfVertices) / (2 * PI);

        ans.push_back(VertexFormat(center + glm::vec3(radius * cos(rad), radius * sin(rad), 0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)));
    }

    return ans;
}

vector<unsigned int> Lab2::buildCirclesTriangle(int numberOfVertices)
{
